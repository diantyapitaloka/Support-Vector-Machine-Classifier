...
- Because the decision boundary is to determined strictly by the support vectors, the model is generally not affected by other data points far away from the margin. This is will makes to the SVM highly efficient and robust, as adding more chickens deep within the "chicken zone" won't change how the boundary is drawn.
